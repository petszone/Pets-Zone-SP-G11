...
<html lang="en" data-theme-mode="light" dir="rtl" direction="rtl" style="direction:rtl;">
	...
	<head>
		...
		<meta name="description" content="Pets Zone" />
		...
		<link href="{{asset('admin/css/custom_rtl.css')}}" rel="stylesheet" type="text/css" />
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="{{asset('admin/media/logos/pets zone.png')}}" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="/">
				<img alt="Logo" src="{{asset('admin/media/logos/pets zone.png')}}" class="logo_nav"/>
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						<!--begin::Logo-->
						<a href="/" class="brand-logo" style="display: block;margin-left: auto;margin-right: auto;">
							<img alt="Logo" src="{{asset('admin/media/logos/pets zone.png')}}" class="h-60px" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
						<button class="brand-toggle btn btn-sm px-0" id="kt_aside_toggle">
							<span class="svg-icon svg-icon svg-icon-xl">
								<!--begin::Svg Icon | path:media/svg/icons/Text/Toggle-Right.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							<!--begin::Menu Nav-->
								<ul class="menu-nav">
									@if(auth('employee')->check() && auth('employee')->user()->can('view_chat'))
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('adm.chats.index')}}" class="menu-link">
												...
												<span class="menu-text">شات الطبيب</span>
											</a>
										</li>
									@endif
									@if(auth('employee')->check() && auth('employee')->user()->can('control_dashboard') || auth('admin')->check())
										<li class="menu-item" aria-haspopup="true">
									...
									@endif
									@if(auth('employee')->check() && auth('employee')->user()->can('view_product') || auth('admin')->check())
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('adm.product.index')}}" class="menu-link">
												<span class="svg-icon menu-icon">
													<!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									@endif
									@if(auth('employee')->check() && auth('employee')->user()->can('view_order') || auth('admin')->check())
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('adm.order.index')}}" class="menu-link">
												<span class="svg-icon menu-icon">
													<!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									@endif
									@if(auth('employee')->check() && auth('employee')->user()->can('view_announce') || auth('admin')->check())
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('adm.announces.index')}}" class="menu-link">
												<span class="svg-icon menu-icon">
													<!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									@endif
									@if(auth('employee')->check() && auth('employee')->user()->can('view_appointment') || auth('admin')->check())
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('adm.appointments.index')}}" class="menu-link">
												<span class="svg-icon menu-icon">
													<!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												...
												<span class="menu-text">حجوزات الطبيب</span>
											</a>
										</li>
									@endif
									@if(auth('employee')->check() && auth('employee')->user()->can('view_role') || auth('admin')->check())
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('adm.roles.index')}}" class="menu-link">
												<span class="svg-icon menu-icon">
													<!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									@endif
									@if(auth('employee')->check() && auth('employee')->user()->can('view_employee') || auth('admin')->check())
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('adm.employees.index')}}" class="menu-link">
												<span class="svg-icon menu-icon">
													<!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					...
					<div class="container-fluid d-flex align-items-stretch justify-content-between">
						...
						<div class="topbar">
							...
							<div class="topbar-item ml-4">
								<div class="btn btn-light-primary p-3">
									{{-- <img src="{{asset('admin/media/svg/avatars/004-boy-1.svg')}}" class="h-30px align-self-end" alt="" /> --}}
							...
							<div class="topbar-item ml-4">
								<div class="btn btn-icon btn-light-primary h-40px w-40px p-0" id="kt_quick_user_toggle">
									<a href=" ">
										{{-- <img src="{{auth()->user()->avatar !== null ? auth()->user()->avatar : asset('media/svg/avatars/004-boy-1.svg')}}" class="h-30px align-self-end" alt="" /> --}}
										<img src="{{asset('admin/media/logos/pets zone.png')}}" alt="" class="h-20px align-self-end">
									</a>
								</div>
                    ...
                    <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                        ...
                        <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="" target="_blank" class="text-dark-75 text-hover-primary">Pets Zone</a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Nav-->
                            <div class="nav nav-dark">
                                {{-- <a href="" target="_blank" class="nav-link pl-0 pr-2">About</a>
                                <a href="" target="_blank" class="nav-link pr-2">Team</a> --}}
                                <a href="" target="_blank" class="nav-link pr-0">تواصل</a>
                            </div>
                            <!--end::Nav-->
                        </div>
                        <!--end::Container-->
