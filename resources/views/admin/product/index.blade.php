                ...
                <div class="card card-custom">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <a href="{{route('adm.product.create')}}" class="btn btn-light-primary font-weight-bold">إضافة منتج</a>&nbsp&nbsp
                        </div>
                    </div>
                    <div class="card card-custom">
                        <div class="card-body">
                            ...
                            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable_2">
                                ...
                                <tbody>
                                    @foreach ($products as $key=>$item)
                                        <tr>
                                            <td>{{$key + 1}}</td>
                                            <td><img src="{{$item->media[0]->link}}" alt="" style="width: 95px;"></td>
                                            <td>{{$item->name}}</td>
                                            <td>{{$item->price}}</td>
                                            <td>{{$item->instock}}</td>
                                            <td data-field="Actions" data-autohide-disabled="false" aria-label="null" class="datatable-cell">
                                                <span style="overflow: visible; position: relative; width: 125px;">
                                                    <a href="{{route('adm.product.edit', ['id' => $item->id])}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
