                    ...
                    <div class="col-12">
                        <div class="card card-custom card-stretch gutter-b">
                            <div class="card card-custom">
                                ...
                                <form class="form form-horizontal" action="{{route('adm.roles.update', ['id' => $role->id])}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="typeahead">
                                                    <input class="form-control" type="text" placeholder="الاسم" name="name" value="{{$role->name}}"/>
                                                    @error('name')
                                                        ...
                                                        @foreach ($item as $key=>$value)
                                                            <td>
                                                                <div class="form-check form-check-custom form-check-success form-check-solid keep-sign">
                                                                    <input class="form-check-input" type="checkbox" name="permission[]" {{in_array($value->id ,$rolePermissions)  ? 'checked' : ''}} value="{{$value->id}}">
