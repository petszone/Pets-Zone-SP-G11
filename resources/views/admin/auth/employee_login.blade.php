        ...
        <div class="container row">
            <div class="col-lg-6 d-flex align-items-center">
                ...
                <div class="login-form login-signin">
                    <!--begin::Form-->
                    <form method="POST" action="{{ route('adm.employee.login.post') }}" class="form w-xxl-550px rounded-lg p-20" >
                        @csrf
                        <!--begin::Title-->
                        <div class="pb-13 pt-lg-0 pt-5">
                            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg text-right">صفحة دخول الموظفين</h3>
                        </div>
                        <!--begin::Title-->
                        <!--begin::Form group-->
