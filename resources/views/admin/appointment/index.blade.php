                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">حجوزات الطبيب</h3>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td data-field="Actions" data-autohide-disabled="false" aria-label="null" class="datatable-cell">
                                                <span style="overflow: visible; position: relative; width: 125px;">
                                                    <a href="{{route('adm.appointments.show', ['id' => $item->id])}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
...
@section('js')
    ...
    <script>
        $(".deleteRecord").click(function(e){
            ...
            let id = $(this).data("id");
            let url = "{{route('adm.appointments.destroy', ['ID'])}}";
