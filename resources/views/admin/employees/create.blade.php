                    ...
                    <div class="col-12">
                        <div class="card card-custom card-stretch gutter-b">
                            <div class="card card-custom">
                                ...
                                <form class="form form-horizontal" action="{{route('adm.employees.store')}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="typeahead">
                                                    <input class="form-control" type="text" placeholder="الاسم الأول" name="firstname" value="{{old('firstname')}}"/>
                                                    @error('firstname')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="typeahead">
                                                    <input class="form-control" type="text" placeholder="الاسم الثاني" name="lastname" value="{{old('lastname')}}"/>
                                                    @error('lastname')
                                                        <div class="form-control-feedback text-danger">
                                                            {{ $message }}
                                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label text-right col-lg-3 col-sm-12">كلمة المرور</label>
                                            <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="typeahead">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="typeahead">
                                                    <input class="form-control" type="text" placeholder="الجوال" name="phone" />
                                                    @error('phone')
                                                        <div class="form-control-feedback text-danger">
                                                            {{ $message }}
                                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-12">
                                                <div class="typeahead">
                                                    <select class="form-control" data-control="select2" data-placeholder="Choose Role" name="roles">
                                                        <option>اختر</option>
                                                        @foreach ($roles as $item)
                                                            <option value="{{$item->id}}" @if($item->id == old('roles')) selected @endif>{{$item->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('roles')
                                                        <div class="form-control-feedback text-danger">
