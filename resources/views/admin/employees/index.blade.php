                ...
                <div class="card card-custom">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <a href="{{route('adm.employees.create')}}" class="btn btn-primary btn-sm"><i class="ft-plus white"></i>إضافة موظف جديد</a>
                        </div>
                    </div>
                    <div class="card card-custom">
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td data-field="Actions" data-autohide-disabled="false" aria-label="null" class="datatable-cell">
                                                <span style="overflow: visible; position: relative; width: 125px;">
                                                    <a href="{{route('adm.employees.edit', ['id' => $item->id])}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
    ...
    <script>
     ...
     <script>
        $(".deleteRecord").click(function(e){
            ...
            let id = $(this).data("id");
            let url = "{{route('adm.employees.destroy', ['ID'])}}";
